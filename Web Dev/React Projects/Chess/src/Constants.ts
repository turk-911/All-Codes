...
export const initialBoard: Board = new Board([
    ...
    new Piece(new Position(0, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(1, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(2, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(3, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(4, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(5, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(6, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    new Piece(new Position(7, 6), PieceType.PAWN, TeamType.OPPONENT, false),
    ...
    new Piece(new Position(0, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(1, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(2, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(3, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(4, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(5, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(6, 1), PieceType.PAWN, TeamType.OUR, false),
    new Piece(new Position(7, 1), PieceType.PAWN, TeamType.OUR, false),
